...
export const LIST_BY_ID_CHANGE_STATUS = 'DOCUMENTS/LIST_BY_ID_CHANGE_STATUS/FAILED'
export const LIST_REQUESTED = 'DOCUMENTS/LIST/REQUESTED'
export const LIST_SUCCEEDED = 'DOCUMENTS/LIST/SUCCEEDED'
export const LIST_SUCCEEDED_2 = 'DOCUMENTS/LIST/LIST_SUCCEEDED_2'
export const LIST_FAILED = 'DOCUMENTS/LIST/FAILED'
export const LIST_CHANGE_STATUS = 'DOCUMENTS/LIST_CHANGE_STATUS/FAILED'
